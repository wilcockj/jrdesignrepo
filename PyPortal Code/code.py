...
button_a1 = Button(x=5, y=80,
                  width=310, height=100,
                  label="Animation 1", label_font=font, label_color=0xffffff,
                  fill_color=DARK_ORANGE, outline_color=OUTLINE_COLOR)
buttons.append(button_a1)  # adding this button to the buttons group
page1.append(buttons[0])

button_a2 = Button(x=5, y=190,
                  width=310, height=100,
                  label="Animation 2", label_font=font, label_color=0xffffff,
                  fill_color=DARK_ORANGE, outline_color=OUTLINE_COLOR)
buttons.append(button_a2)  # adding this button to the buttons group
page1.append(buttons[1])

button_a3 = Button(x=5, y=300,
                  width=310, height=100,
                  label="Animation 3", label_font=font, label_color=0xffffff,
                  fill_color=DARK_ORANGE, outline_color=OUTLINE_COLOR)
...
button_page11 = Button(x=5, y=5,
                  width=150, height=65,
                  label="Animations", label_font=font, label_color=0xffffff,
                  fill_color=GRAY, outline_color=OUTLINE_COLOR)
buttons.append(button_page11)  # adding this button to the buttons group
page1.append(buttons[19])

button_page21 = Button(x=165, y=5,
                  width=150, height=65,
                  label="Custom", label_font=font, label_color=0xffffff,
                  fill_color=DARK_GRAY, outline_color=OUTLINE_COLOR)
...
button_page22 = Button(x=165, y=5,
                  width=150, height=65,
                  label="Custom", label_font=font, label_color=0xffffff,
                  fill_color=DARK_GRAY, outline_color=OUTLINE_COLOR)
...
button_send1 = Button(x=5, y=410,
                  width=310, height=65,
                  label="Send", label_font=font, label_color=0xffffff,
                  fill_color=DARK_GRAY, outline_color=OUTLINE_COLOR)
buttons.append(button_send1)  # adding this button to the buttons group
page1.append(buttons[23])

#exact copy for second display group
button_send2 = Button(x=5, y=410,
                  width=310, height=65,
                  label="Send", label_font=font, label_color=0xffffff,
                  fill_color=DARK_GRAY, outline_color=OUTLINE_COLOR)
...
data2 = {'message': '0', 'color': '0', 'speed': '0'}  #json struct {message, color, speed}
check = '0'
